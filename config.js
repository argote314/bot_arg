...
module.exports = kconfig = async (kill, message) => {
    ...
    try {
        ...
        case 'nasa':
        	if (args[0] == '-data') {
				...
				if (config.lang == 'en') return await kill.sendFileFromUrl(from, `${nasa.data.url}`, '', `${nasa.data.date} → ${nasa.data.title}\n\n ${nasa.data.explanation}`, id)
				await sleep(4000)
            	await translate(nasa.data.explanation, 'es').then(async (result) => { await kill.sendFileFromUrl(from, `${nasa.data.url}`, '', `${nasa.data.date} → ${nasa.data.title}\n\n ${result}`, id) })
			}
			break
       ...
       case 'ihentai':
		...
		case 'ranking':
			...
			msgcount.sort((a, b) => (a.msg < b.msg) ? 1 : -1)
            let board = '┏͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓͓━━━━⃦❰ _*⚒⃟꙱RANKING⛃*_ ❱⃦━━━━\n   *Ranking de xp*\n    ──────────────────\n\n'
            try {
                for (let i = 0; i < 10; i++) {
					var role = patents.a0
					...
					board += `${i + 1} *❯⃫✓ ${getTheName}*\n*➦꙱⃫ᗌ _Mensajes_ ➙* ${msgcount[i].msg}\n*➦꙱⃫ᗌ _XP_ ➙* ${nivel[i].xp}\n*➦꙱⃫ᗌ _Level_ ➙* ${nivel[i].level}\n*➦꙱⃫ᗌ _Clase_ ➙* ${role}\n\n`
                }
	...
	*/
		...
		case 'rankbot':
			const rankigkn = await fs.readFileSync('./lib/config/Bot/ganadores.txt').toString()
			await kill.reply(from, rankigkn,id)
			break
